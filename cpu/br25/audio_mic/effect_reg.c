...
/*说明：1、无损解码 不能与变声 MIC_EFFECT_CONFIG_PITCH 同开
 * 		2、无损解码 不能与啸叫抑制 MIC_EFFECT_CONFIG_HOWLING 同开
 *      3、mic采样率与DAC 采样率不一致时需打开软件变采样 MIC_EFFECT_CONFIG_SOFT_SRC
 */
...
audio_energy_detect_param mic_energy_det_param = {
    .mute_energy = 150, //阈值与mic gain 相关，不同micgain 需要调整
    .unmute_energy = 250,
    .mute_time_ms = 500,
    .unmute_time_ms = 50,
    .count_cycle_ms = 5,
