...
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
...
#else
        KEY_POWEROFF, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,	    KEY_NULL,			KEY_NULL
#endif
    },
    [1] = {
       KEY_VOL_DOWN ,	KEY_MUSIC_PREV	,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [2] = {
        KEY_VOL_UP,	KEY_MUSIC_NEXT,	KEY_NULL,			KEY_NULL,		KEY_NULL,	KEY_NULL
    },
    [3] = {
    ...
    [5] = {
        KEY_NULL,		KEY_BT_PAIR,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [6] = {
...
const u16 fm_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_POWEROFF, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_FM_SCAN_ALL_DOWN,			KEY_NULL
    },
		[1] = {
				KEY_VOL_DOWN, 	KEY_FM_PREV_STATION, 		KEY_NULL, 		KEY_NULL, 	KEY_NULL, 		KEY_NULL
		},
		[2] = {
				KEY_VOL_UP, KEY_FM_NEXT_STATION, KEY_NULL, 		KEY_NULL, 	KEY_NULL, KEY_NULL
		},
		[3] = {
		...
		[5] = {
				KEY_BT_PAIR,		KEY_NULL, 		KEY_NULL, 		KEY_NULL, 	KEY_NULL, 		KEY_NULL
		},
		[6] = {
				KEY_NULL, KEY_NULL, 		KEY_NULL, 		KEY_NULL, 	KEY_NULL, KEY_NULL
		},
...
const u16 rtc_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [1] = {
        KEY_RTC_DOWN,			KEY_NULL,		KEY_NULL,		KEY_NULL,		KEY_NULL,				KEY_NULL
    },
    [2] = {
        KEY_RTC_UP,		KEY_NULL,		KEY_NULL,		KEY_NULL,		KEY_NULL,				KEY_NULL
    },
    [3] = {
        KEY_RTC_STATUS,			 KEY_RTC_SET_ALARM,		KEY_NULL,		KEY_NULL,		KEY_NULL,				KEY_NULL
    },
    [4] = {
        KEY_CHANGE_MODE,		KEY_RTC_SW_POS,	KEY_NULL,	KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [5] = {
        KEY_NULL,			KEY_NULL,		KEY_NULL,		KEY_NULL,		KEY_NULL,				KEY_NULL
    },
